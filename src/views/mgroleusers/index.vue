...
<script>
import { pageLinkSysUser, linkOrUnlinkSysFunction,prePageLinkSysUser } from "../../api/myrole";
...
export default {
	...
	methods: {
        ...
        unlink(){
            linkOrUnlinkSysFunction({functionIds:this.selectedRowKeys,roleId:this.$route.query.id}).then(()=>{
                this.$message.success("操作成功")
                this.getList()
            })
        },
		getSelects() {
			prePageLinkSysUser({roleId:this.$route.query.id}).then((res) => {
